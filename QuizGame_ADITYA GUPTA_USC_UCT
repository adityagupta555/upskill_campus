...
question_data = [
    ('What is the capital of India', 'Delhi', 'Rome', 'Berlin', 'Madrid', 'A'),
    ('Which is the largest planet ?', 'Venus', 'Mars', 'Jupiter', 'Saturn', 'C'),
    ('Who painted the Last-supper?', 'Leonardo da Vinci', 'Pablo Picasso', 'Vincent van Gogh', 'Michelangelo', 'A'),
    ('What is the chemical symbol for silver', 'Ag', 'Fe', 'Au', 'Hg', 'A'),
    ('Who is the national animal?', 'Austrila', 'India', 'Brazil', 'South Africa', 'B'),
    ('Who wrote the play "Merchant of venice"?', 'William Shakespeare', 'George Orwell', 'Jane Austen', 'Charles Dickens', 'A'),
    ('What is the largest ocean in the world?', 'Atlantic Ocean', 'Arctic Ocean', 'Indian Ocean', 'Pacific Ocean', 'D'),
    ('In which year India got independence', '1939', '1947', '1942', '1950', 'B'),
    ...
    ('What is the capital of maharashtra?','Mumbai','Vizag','Kurnool','All the above','A')
]
